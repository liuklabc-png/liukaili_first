...
export const OutlineEditor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-pink-50 flex flex-col">
        ...
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              ...
              <span className="text-base md:text-xl font-bold bg-gradient-to-r from-blue-500 to-pink-600 bg-clip-text text-transparent">卓幻</span>
            </div>
      ...
      {/* 上下文栏 */}
      <div className="bg-zollent-50 border-b border-zollent-100 px-3 md:px-6 py-2 md:py-3 max-h-32 overflow-y-auto flex-shrink-0">
                ...
                <ul className="space-y-1.5 md:space-y-2">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-sm md:text-base text-gray-700">
                      <span className="mr-2 text-zollent-500 flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
                ...
                <ul className="space-y-1">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-xs text-gray-700">
                      <span className="mr-1.5 text-zollent-500 flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
