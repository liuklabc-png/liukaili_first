...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen radial-bg relative overflow-hidden">
      {/* 点阵纹理 */}
      <div className="absolute inset-0 dotted-texture"></div>
      {/* 背景装饰元素 */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-600/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      {/* 导航栏 */}
      <nav className="relative h-16 md:h-18 glass-effect border border-white/30">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center">
              <img
                src="/logo.ico"
                alt="卓幻 Zoellent Slides Logo"
                className="h-10 md:h-12 w-auto rounded-lg object-contain"
              />
            </div>
            <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-pink-500 bg-clip-text text-transparent">
              卓幻
            </span>
          </div>
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Button
              ...
              className="hidden sm:inline-flex hover:bg-primary-blue-pale hover:shadow-sm hover:scale-105 transition-all duration-200 font-medium"
            >
            ...
            <Button
              ...
              onClick={handleOpenMaterialModal}
              className="sm:hidden hover:bg-primary-blue-pale hover:shadow-sm hover:scale-105 transition-all duration-200"
              title="素材生成"
            />
            {/* 桌面端：带文字的素材中心按钮 */}
            <Button
            ...
            <Button 
              ...
              className="text-xs md:text-sm hover:bg-primary-blue-pale hover:shadow-sm hover:scale-105 transition-all duration-200 font-medium"
            >
            ...
            <Button
              ...
              className="hidden md:inline-flex hover:bg-primary-blue-pale"
            >
              帮助
            </Button>
            {/* 移动端帮助按钮 */}
            <Button
              ...
              onClick={() => setIsHelpModalOpen(true)}
              className="md:hidden hover:bg-primary-blue-pale hover:shadow-sm hover:scale-105 transition-all duration-200"
              title="帮助"
            />
          </div>
        </div>
      ...
      <main className="relative max-w-5xl mx-auto px-3 md:px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-blue-200/50 shadow-sm mb-4">
            <span className="text-2xl animate-pulse"><Sparkles size={20} color="blue" /></span>
            <span className="text-sm font-medium text-gray-700">你的专属人工智能PPT生成器</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
            <span className="bg-gradient-to-r from-blue-500 to-pink-600 bg-clip-text text-transparent" style={{
        ...
        {/* 创建卡片 */}
        <Card className="p-4 md:p-10 glass-effect hover:shadow-3xl hover:glow-border transition-all duration-300">
          {/* 选项卡 */}
          ...
          <div className="relative">
            <p className="text-sm md:text-base mb-4 md:mb-6 leading-relaxed">
              <span className="inline-flex items-center gap-2 text-gray-700">
                <Lightbulb size={16} className="text-primary-blue-light flex-shrink-0" />
          ...
          <div className="relative mb-2 group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-pink-500 rounded-lg opacity-0 group-hover:opacity-20 blur transition-opacity duration-300"></div>
            <Textarea
              ref={textareaRef}
              ...
              className="relative pr-20 md:pr-28 pb-12 md:pb-14 text-sm md:text-base border-2 border-gray-200 focus:border-blue-600 transition-colors duration-200" // 为右下角按钮留空间
            />
            ...
            <div className="absolute right-2 md:right-3 bottom-2 md:bottom-3 z-10">
              ...
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg hover:shadow-xl text-xs md:text-sm px-3 md:px-4"
            >
                {referenceFiles.some(f => f.parse_status === 'pending' || f.parse_status === 'parsing')
                  ? '解析中...'
                  : '下一步'}
            ...
            <div className="flex items-center justify-between mb-3 md:mb-4">
              ...
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-zollent-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-zollent-500"></div>
                </div>
              </label>
            </div>
            ...
            {useTemplateStyle ? (
              <div className="space-y-3">
                <Textarea
                  ...
                  rows={3}
                  className="text-sm border-2 border-gray-200 focus:border-zollent-400 transition-colors duration-200"
                />
                    ...
                    {PRESET_STYLES.map((preset) => (
                      <div key={preset.id} className="relative">
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-medium rounded-full border-2 border-gray-200 hover:border-zollent-400 hover:bg-zollent-50 transition-all duration-200 hover:shadow-sm"
                        >
                          {preset.name}
                        </button>
                        ...
                        {hoveredPresetId === preset.id && preset.previewImage && (
                          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
                            <div className="bg-white rounded-lg shadow-2xl border-2 border-zollent-400 p-2.5 w-72">
                              <img
                            ...
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1">
                              <div className="w-3 h-3 bg-white border-r-2 border-b-2 border-zollent-400 transform rotate-45"></div>
                            </div>
                          </div>
                        )}
                      </div>
