...
export const SlidePreview: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-white to-pink-50 flex flex-col overflow-hidden">
      {/* 顶栏 */}
      <header className="h-14 md:h-16 bg-white shadow-sm border-b border-gray-200 flex items-center justify-between px-3 md:px-6 flex-shrink-0">
        <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 min-w-0">
            ...
            <span className="text-base md:text-xl font-bold truncate bg-gradient-to-r from-blue-500 to-pink-600 bg-clip-text text-transparent">卓幻</span>
          </div>
            ...
            <div className="relative">
              ...
              >
                {exportTasks.filter(t => t.projectId === projectId && (t.status === 'PROCESSING' || t.status === 'RUNNING' || t.status === 'PENDING')).length > 0 ? (
                  <Loader2 size={16} className="animate-spin text-zollent-500" />
                ) : (
                  <FileText size={16} />
                )}
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-w-0 min-h-0">
            ...
            <div className="flex items-center gap-2 text-xs mb-3">
              <button
                ...
                className={`px-2 py-1 rounded transition-colors flex items-center gap-1 ${
                  isMultiSelectMode 
                    ? 'bg-zollent-100 text-zollent-700 hover:bg-zollent-200' 
              ...
              {isMultiSelectMode && (
                <>
                  <button
                    ...
                    className="text-gray-500 hover:text-zollent-600 transition-colors"
                  >
                    {selectedPageIds.size === pagesWithImages.length ? '取消全选' : '全选'}
                  </button>
                  {selectedPageIds.size > 0 && (
                    <span className="text-zollent-600 font-medium">
                  ...
                  <div className="md:hidden relative">
                    <button
                      ...
                      className={`w-20 h-14 rounded border-2 transition-all ${
                        selectedIndex === index
                          ? 'border-zollent-500 shadow-md'
                          : 'border-gray-200'
                      } ${isMultiSelectMode && page.id && selectedPageIds.has(page.id) ? 'ring-2 ring-zollent-400' : ''}`}
                    >
                    ...
                    {isMultiSelectMode && page.id && page.generated_image_path && (
                      <button
                        ...
                        className={`absolute top-2 left-2 z-10 w-6 h-6 rounded flex items-center justify-center transition-all ${
                          selectedPageIds.has(page.id)
                            ? 'bg-zollent-500 text-white shadow-md'
                            : 'bg-white/90 border-2 border-gray-300 hover:border-zollent-400'
                        }`}
                      >
        ...
        {/* 右侧：大图预览 */}
        <main className="flex-1 flex flex-col bg-gradient-to-br from-zollent-50 via-white to-gray-50 min-w-0 overflow-hidden">
                            ...
                            {imageVersions.map((version) => (
                              <button
                                ...
                                className={`w-full px-3 md:px-4 py-2 text-left hover:bg-gray-50 transition-colors flex items-center justify-between text-xs md:text-sm ${
                                  version.is_current ? 'bg-zollent-50' : ''
                                }`}
                              >
                                <div className="flex items-center gap-2">
                                  ...
                                  {version.is_current && (
                                    <span className="text-xs text-zollent-600 font-medium">
                                      (当前)
                                    </span>
                                  )}
                                </div>
            ...
            {imageUrl && (
              <>
                ...
                <button
                  ...
                  className="absolute top-2 left-2 z-10 px-2 py-1 rounded bg-white/80 text-[10px] text-gray-700 hover:bg-zollent-50 shadow-sm flex items-center gap-1"
                >
                  <Sparkles size={12} />
                ...
                {selectionRect && (
                  <div
                    className="absolute border-2 border-zollent-500 bg-zollent-400/10 pointer-events-none"
                    style={{
              ...
              <div className="px-4 pb-4 space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zollent-500"
                    placeholder="输入页面标题"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zollent-500 resize-none"
            ...
            {isDescriptionExpanded && (
              <div className="px-4 pb-4">
                <textarea
                  ...
                  rows={8}
                  className="w-full px-3 py-2 text-sm border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zollent-500 resize-none"
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 space-y-4">
            ...
            {currentProject?.template_image_path && (
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 text-zollent-600 rounded focus:ring-zollent-500"
                />
                    ...
                    {descImageUrls.map((url, idx) => (
                      <div key={idx} className="relative group">
                        ...
                        {selectedContextImages.descImageUrls.includes(url) && (
                          <div className="absolute inset-0 bg-zollent-500/20 border-2 border-zollent-500 rounded flex items-center justify-center">
                            <div className="w-6 h-6 bg-zollent-500 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <label className="w-20 h-20 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:border-zollent-500 transition-colors">
