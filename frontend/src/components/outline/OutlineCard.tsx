  ...
  return (
    <Card
      className={`p-4 relative ${
        isSelected ? 'border-2 border-zollent-500 shadow-yellow' : ''
      }`}
          ...
          {isEditing ? (
            ...
            <div className="space-y-3" onClick={(e) => e.stopPropagation()}>
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zollent-500"
                placeholder="标题"
              />
              <textarea
                value={editPoints}
                ...
                rows={5}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zollent-500 resize-none"
                placeholder="要点（每行一个）"
              />
              <div className="flex justify-end gap-2">
                ...
                <button
                  onClick={handleSave}
                  className="px-3 py-1.5 text-sm bg-zollent-500 text-black rounded-lg hover:bg-zollent-600 transition-colors"
                >
        ...
        {!isEditing && (
          <div className="flex-shrink-0 flex gap-2">
            <button
              ...
              className="p-1.5 text-gray-500 hover:text-zollent-600 hover:bg-zollent-50 rounded transition-colors"
            >
              <Edit2 size={16} />
            </button>
            <button
