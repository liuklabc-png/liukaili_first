  ...
  return (
    <Card
      className={`p-3 md:p-6 transition-all ${
        isSelected 
          ? 'border-2 border-zollent-500 bg-zollent-50' 
      ...
      <div className="flex items-start gap-3 md:gap-4">
        ...
        <div className="pt-1 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
          <input
            ...
            className="w-4 h-4 text-zollent-600 border-gray-300 rounded focus:ring-zollent-500 cursor-pointer"
          />
        </div>
          ...
          <div className="flex items-center gap-2 md:gap-3 mb-2 flex-wrap">
            {isEditing ? (
              <input
                ...
                autoFocus
                className="text-base md:text-lg font-semibold text-gray-900 px-2 py-1 border border-zollent-500 rounded focus:outline-none focus:ring-2 focus:ring-zollent-500 flex-1 min-w-0"
              ...
              <h3 
                className={`text-base md:text-lg font-semibold text-gray-900 truncate flex-1 min-w-0 ${
                  isBatchMode 
                    ? 'cursor-default' 
                    : 'cursor-pointer hover:text-zollent-600 transition-colors'
                }`}
