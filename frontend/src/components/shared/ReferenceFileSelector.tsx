        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-1.5 text-sm border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-zollent-500"
            >
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${isSelected ? 'bg-zollent-50 border-l-4 border-l-zollent-500' : 'hover:bg-gray-50'}
                      ...
                      <div className="flex-shrink-0 mt-1">
                        <div
                          className={`
                            ...
                            ${isSelected
                              ? 'bg-zollent-500 border-zollent-500'
                              : 'border-gray-300'
                            }
