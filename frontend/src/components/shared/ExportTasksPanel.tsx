...
const TaskStatusIcon: React.FC<{ status: ExportTask['status'] }> = ({ status }) => {
  switch (status) {
    ...
    case 'PROCESSING':
    case 'RUNNING':
      return <Loader2 size={16} className="text-zollent-500 animate-spin" />;
    case 'COMPLETED':
            ...
            {task.progress ? (
              <>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-zollent-600">
                ...
                <div className="h-2.5 bg-gray-200 rounded-full overflow-hidden shadow-inner">
                  <div
                    className="h-full bg-gradient-to-r from-zollent-500 to-zollent-600 transition-all duration-500 ease-out"
              ...
              <div className="flex items-center gap-2">
                <div className="h-2.5 w-full bg-gray-200 rounded-full overflow-hidden">
                  <div className="h-full bg-zollent-500 animate-pulse" style={{ width: '30%' }} />
                </div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {activeTasks.length > 0 && (
            <span className="px-1.5 py-0.5 text-xs bg-zollent-100 text-zollent-700 rounded-full">
