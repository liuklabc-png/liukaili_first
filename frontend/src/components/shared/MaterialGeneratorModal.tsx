      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="space-y-2">
              ...
              <label className="w-40 h-28 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:border-zollent-500 transition-colors bg-white relative group">
                {refImage ? (
                  <>
                    <img
            ...
            <div className="flex-1 space-y-2 min-w-[180px]">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <label className="w-20 h-20 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:border-zollent-500 transition-colors bg-white">
        ...
        <div className="flex justify-end gap-3 pt-2">
          ...
          <Button
            ...
            disabled={!prompt.trim() || isCompleted}
            loading={isGenerating}
          >
            {isCompleted ? '已完成' : '生成素材'}
          </Button>
        </div>
      </div>
      {/* 素材选择器 */}
