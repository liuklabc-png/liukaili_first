      ...
      <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              {userTemplates.map((template) => (
                ...
                >
                  ...
                  {selectedTemplateId === template.template_id && (
                    <div className="absolute inset-0 bg-zollent-500 bg-opacity-20 flex items-center justify-center pointer-events-none">
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-4">
              ...
              <div
                ...
                className={`aspect-[4/3] rounded-lg border-2 cursor-pointer transition-all bg-gray-100 flex items-center justify-center relative ${
                  selectedPresetTemplateId === template.id
                    ? 'border-zollent-500 ring-2 ring-zollent-200'
                    : 'border-gray-200 hover:border-zollent-500'
                }`}
              >
                {template.preview ? (
                  <>
            ...
            {/* 上传新模板 */}
            <label className="aspect-[4/3] rounded-lg border-2 border-dashed border-gray-300 hover:border-zollent-500 cursor-pointer transition-all flex flex-col items-center justify-center gap-2 relative overflow-hidden">
