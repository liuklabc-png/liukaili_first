...
class Settings(db.Model):
    ...
    model_suite = db.Column(db.String(20), nullable=True)         # 模型套系: nanozollent, qwen, doubao (NULL=use .env)
    ...
    text_model_source = db.Column(db.String(50), nullable=True)           # 文本模型提供商 (gemini, openai, qwen, doubao, ...)
    ...
    def to_dict(self):
        ...
        return {
            'id': self.id,
            'model_suite': self._val('model_suite', d),
    ...
    def _get_config_defaults():
        ...
        return {
            'model_suite': getattr(Config, 'MODEL_SUITE', 'nanozollent'),
